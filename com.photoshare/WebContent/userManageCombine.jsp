...
pageEncoding="UTF-8" import="com.photoshare.model.Picture" import="com.photoshare.controler.GetPicture" import="java.util.ArrayList" import="com.photoshare.controler.CheckManager"%>
    <%@include file="checkuser.jsp" %>
        ...
        <![endif]-->
            ...
            ArrayList<Picture> checklist=getter.getPictureOrderByTest(0, 1);
        %>
                                    <div class="container">
                                            ...
                                            <%for(Picture picture:checklist){ %>
                                                <div class="photo-info">
                                                    ...
                                                    <div class="photo-description">
                                                        <div class="photo">
                                                            <img src="images/<%=picture.getUsername()%>/temp/<%=picture.getMd5()+'.'+picture.getFormat() %>" alt="图片 ">
                                                        </div>
                                                    ...
                                                    <div class="check">
                                                        <div class="pass">
                                                            <input type="checkbox" id="passbox">
                                                        ...
                                                        <div class="nopass">
                                                            <input type="checkbox" id="nopassbox">
                                                            <svg class="icon" aria-hidden="true">
                                                                <use xlink:href="#icon-edit"></use>
                                                            </svg>
                                                            <span>审核不通过</span>
                    ...
                    %>
                                            ...
                                            <%for(Picture picture:showlist){%>
                                                <div class="photo-info">
                                                    ...
                                                    <div class="photo-description">
                                                        <div class="photo">
                                                            <%if(picture.isTest()){%>
                                                                <img src="images/<%=picture.getUsername() %>/<%=picture.getMd5()+" . "+picture.getFormat()%>" alt="图片">
                                                                <%} %>
                                                        </div>
                                                        <div class="photo-description-content">
                                                            <p>
                                ...
                                <div class="container">
                                    <div class="row upload">
                                        ...
                                        <div class="content">
                                            ...
                                            if(file.exists()){
                                    %>
                                                    <img src="images/<%=user.getName()%>/head/user.jpg" alt="上传图片">
                                                    <%}else{%>
                                ...
                                <div class="container">
                                    <div class="row upload">
                                        ...
                                        <div class="content">
                                            ...
                                            if(file.exists()){
                                    %>
                                                    <img src="images/<%=user.getName()%>/head/user.jpg" alt="上传头像">
                                                    <%}else{%>
                        ...
                        <div id="sidebar">
                            <ul>
                            	<%CheckManager manager=new CheckManager(user,conn);
                            	if(manager.check()){
                            	%>
                ...
                <script type="text/javascript">
                    $(function () {
                        ...
                        $("#passbox").change(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "http://localhost:9999/com.photoshare/TestPicture", //接口地址
                                dataType: "JSON",
                                data: { //传送数据json数据格式
                                    status:"pass",
                                    id:id
                        ...
                        $("#uploadp").click(function () {
                            ...
                            formData.append('name', encodeURI(document.getElementById('pic-name').value));
                            //选中的分类
                            var obj = $('#class');
                            var text = obj.find("option:selected").text();
                            formData.append('table', encodeURI(text));
                            formData.append('description', encodeURI(document.getElementById('description').value));
                        ...
                        $("#uploadinfo").click(function () {
                            ...
                            formData.append('description', encodeURI(document.getElementById('user-introduce').value));
                            alert(document.getElementById('user-introduce').value);
